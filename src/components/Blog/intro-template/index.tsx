...
export default memo(function IntroTemplate() {
  ...
  const hasEnvFile = env.NEXT_PUBLIC_SANITY_PROJECT_ID;
  const hasRepoEnvVars =
    env.NEXT_PUBLIC_VERCEL_GIT_PROVIDER &&
    env.NEXT_PUBLIC_VERCEL_GIT_REPO_OWNER &&
    env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG;
  const repoURL = `https://${env.NEXT_PUBLIC_VERCEL_GIT_PROVIDER}.com/${env.NEXT_PUBLIC_VERCEL_GIT_REPO_OWNER}/${env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG}`;
  const removeBlockURL = hasRepoEnvVars
    ? `https://${env.NEXT_PUBLIC_VERCEL_GIT_PROVIDER}.com/${env.NEXT_PUBLIC_VERCEL_GIT_REPO_OWNER}/${env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG}/blob/main/README.md#how-can-i-remove-the-next-steps-block-from-my-blog`
...
function getGitProvider() {
  switch (env.NEXT_PUBLIC_VERCEL_GIT_PROVIDER) {
    case 'gitlab':
      return 'GitLab';
    case 'bitbucket':
      return 'Bitbucket';
